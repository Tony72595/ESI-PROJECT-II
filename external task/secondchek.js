...
client.subscribe("SecondRoundCheck", async function({ task, taskService }) {
  // Put your business logic
   let gpa = 0
  let comprehensive =0
  if (gpa>=3, comprehensive>=5){
     const processVariables = new Variables();
     processVariables.set("gpa", gpa);
     processVariables.set("comprehensive",comprehensive);
...
const txObject ={
    ...
    gasLimit: web3.utils.toHex(210011),
